...
if(!biicore.isPremium) {
	...
	<div class="bii-logo"><div class="bii-logo-secondary"><div class="bii-logo-secondary-content">FaceBook</div></div><a href="https://www.facebook.com/chinguyen111998" target="_blank"><img src="logo.png" /></a></div>
	<div class="bii-footer" style="background-color: #000;border-top:2px solid #df4759;padding: 15px 0;color:#fff;text-align:center;letter-spacing: 1px;"><div class="container">Xin cảm ơn</div></div>
	`);
}