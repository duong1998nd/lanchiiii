        ...
        $("#wish-form").validate({
            ...
            messages: {
                name: {
                    ...
                    minlength: 'Tên ngắn quá',
                },
                content: {
                    required: 'Chúc gì nói đi',
                    minlength: 'Chúc ngắn quá',
                },
                email: {
                    email: 'Nhập email vào nha'
                }
            },
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        if(!res.error){
                            ...
                            '</strong><p>'+$(form).find("textarea[name='content']").val().replace(/&/g, "&amp;").replace(/>/g, "&gt;").replace(/</g, "&lt;").replace(/"/g, "&quot;")+'</p></div>');
